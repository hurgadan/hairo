...
## Промпт B — Улучшение фото (внутри пайплайна генерации, не отдельный экран)
...
## Промпт C — Генерация причёски на пользователе (экран 8 «Генерация», `PRODUCT.md` 4.1) ⭐ ключевой
